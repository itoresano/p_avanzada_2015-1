...
class Marquiwi(QtGui.QLabel):
    def __init__(self, parent):
        QtGui.QWidget.__init__(self, parent)
        self.parent = parent
        self.rest = False
        self.lado = 25
        self.setPixmap(QtGui.QPixmap(os.getcwd() + "\\Imagenes\\marquiwi - copia.png"))
    ...
    def pocmon_muere(self):
        ...
        self.rest = True
        self.move(self.parent.marquiwi_x, self.parent.marquiwi_y)
        self.x = self.parent.marquiwi_x
        self.y = self.parent.marquiwi_y
