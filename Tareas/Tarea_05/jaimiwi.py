...
class Jaimiwi(QtGui.QLabel):
    def __init__(self, parent):
        QtGui.QWidget.__init__(self, parent)
        self.parent = parent
        self.lado = 25
        self.rest = False
        self.setPixmap(QtGui.QPixmap(os.getcwd() + "\\Imagenes\\jaimiwi - copia.png"))
    ...
    def pocmon_muere(self):
        ...
        self.rest = True
        self.move(self.parent.jaimiwi_x, self.parent.jaimiwi_y)
        self.x = self.parent.jaimiwi_x
        self.y = self.parent.jaimiwi_y
